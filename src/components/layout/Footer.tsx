        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <a href="https://facebook.com/sewakhoj" target="_blank" rel="noopener noreferrer" aria-label="Visit SewaKhoj on Facebook" className="w-10 h-10 bg-white/5 rounded-xl flex items-center justify-center hover:bg-blue-600 transition-all group">
